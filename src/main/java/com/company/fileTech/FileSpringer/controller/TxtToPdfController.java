...
import com.company.fileTech.FileSpringer.service.TxtToPdfService;
...
public class TxtToPdfController {
    ...
    @PostMapping("/file/textToPdf")
    public ResponseEntity<Map<String, Object>> convertTextToPdf(
        ...
        try {
            ...
            // Check if the target format is PDF
            ...
            // Call service to convert text to PDF
            ByteArrayOutputStream pdfOutputStream = txtToPdfService.generatePDFFromText(file);
            ...
            String downloadLink = baseUrl + "/download/textToPdf/" + pdfFileName;
    ...
    @GetMapping("/download/textToPdf/{fileName}")
